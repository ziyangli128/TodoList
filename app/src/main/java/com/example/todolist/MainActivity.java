...
public class MainActivity extends AppCompatActivity {
    // declaring stateful objects; these will be null before onCreate is called
    ...
    // This method removes an item from the list when press and hold that item
    private void setupListViewListener() {
        ...
        lvItems.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                writeItems();
                // inform the user that an item is removed
    ...
    // This method adds a string item entered in the editText box to the todo list.
